    ...
    <section className="py-16 px-4  lg:px-0">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-100 rounded-3xl">
       ...
       <p className="text-lg text-gray-600 mb-6 ">
        ...
        <br/>
Handpicked to elevate your everyday look.
       </p>
       <Link to="/collections/all" className="bg-black text-white px-6 py-3 rounded-lg text-lg hover:bg-gray-800">Shop Now</Link>
       </div>

       <div className="lg:w-1/2">
<img src={featured} alt="Featured collection" className="lg:rounded-tr-3xl lg:rounded-br-3xl w-full h-full object-cover"/>
       </div>
